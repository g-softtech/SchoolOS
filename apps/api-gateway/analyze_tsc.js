...
for (let i = 0; i < lines.length; i++) {
  // Try to match the TS error format without pnpm prefix
...
errors.forEach(e => {
  ...
  } else if (e.message.includes('is not assignable to parameter of type') || e.message.includes('is not assignable to type')) {
